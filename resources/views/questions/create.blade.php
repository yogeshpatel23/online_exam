            ...
            <div class="box box-primary">
                ...
                <form method="POST" action="{{ route('questions.store') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control{{ $errors->has('qbid') ? ' is-invalid' : '' }}" name="qbid" id="qbid">
                                ...
                                @foreach($booklates as $booklate)
                                    <option value="{{ $booklate->qbid }}" {{ old('qbid') == $booklate->qbid ? 'selected':'' }}>{{ $booklate->booklate_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="questions" id="questions" class="form-control{{ $errors->has('questions') ? ' is-invalid' : '' }}" rows="4">{{ old('questions') }}</textarea>
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group mb-3 col-md-6">
                                ...
                                <input id="opt_a" type="text" class="form-control{{ $errors->has('opt_a') ? ' is-invalid' : '' }}" name="opt_a" value="{{ old('opt_a') }}" required>
                            ...
                            <div class="input-group mb-3 col-md-6">
                                ...
                                <input id="opt_b" type="text" class="form-control{{ $errors->has('opt_b') ? ' is-invalid' : '' }}" name="opt_b" value="{{ old('opt_b') }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group mb-3 col-md-6">
                                ...
                                <input id="opt_c" type="text" class="form-control{{ $errors->has('opt_c') ? ' is-invalid' : '' }}" name="opt_c" value="{{ old('opt_c') }}" required>
                            ...
                            <div class="input-group mb-3 col-md-6">
                                ...
                                <input id="opt_d" type="text" class="form-control{{ $errors->has('opt_d') ? ' is-invalid' : '' }}" name="opt_d" value="{{ old('opt_d') }}" required>
